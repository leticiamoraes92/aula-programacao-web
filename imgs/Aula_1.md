...
5) Website builders
Ferramentas para criar sites sem codar tudo na mão.

👍 Vantagens: rapidez, facilidade, custo-benefício, templates responsivos
⚠️ Limitações: menos flexível, performance pode variar, migração pode ser difícil
...
👨‍👩‍👧‍👦 Formar grupos de 3 a 5 pessoas (mesmo grupo nas semanas seguintes)
💡 Elaborar propostas de projetos para apresentar ao professor
🧑‍💻 Criar repositório no GitHub e fazer um resumo em Markdown (.md) da Aula 01
🔎 Escolher 3 sites e analisar tecnologias utilizadas; usar Miro para representar visualmente e salvar a imagem no repositório
